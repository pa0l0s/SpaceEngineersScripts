...
namespace ScriptingClass
{
	public class Program : MyGridProgram
	{
		...
		static string CHANNEL_TAG = "q6ryu3";
		...
		static IMyIntergridCommunicationSystem igc;
		static int Tick = 0;
		IMyCockpit cockpit;
		Radar radar;
		...
		class Radio
		{
			...
			public void TurnON()
			{
				//antenna.Radius = 50000.0f;
			}

			public void Stop()
			{
				// antenna.Radius = 10.0f;
		...
		public class Torpedo
		{
			...
			static public bool CheckBlocks(string GroupName, out string strBlockCheck)
			{
				...
				templist.Clear();
				gts.GetBlocksOfType<IMyCockpit>(templist, (b) => (b.CustomName.Contains(GroupName) && b.IsFunctional));
