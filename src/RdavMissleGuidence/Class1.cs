...
namespace ScriptingClass
{
	public class Program : MyGridProgram
	{
		...
		This Script adds an advanced but leightweight tracking alrorithm for
		...
		Program()
		{
			...
			GridTerminalSystem.GetBlocksOfType<IMyLargeTurretBase>(TempCollection, a => a.CustomName == "#A#");
			...
			GridTerminalSystem.GetBlocksOfType<IMySoundBlock>(TempCollection2);
